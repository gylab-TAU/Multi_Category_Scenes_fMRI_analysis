function Phase3_runGLM(Settings)
...
for DesignNum = 1:length(Settings.ExpDesign)
    ...
    for subj_itr=  1:length(Settings.Sessions)
        ...
        curr_subj_design_stats_path = [curr_subject_spm_path filesep 'Results' Settings.ExpDesign{DesignNum}.Name];
        
        if exist(curr_subj_design_stats_path,'dir')
            rmdir(curr_subj_design_stats_path, 's');
        end
